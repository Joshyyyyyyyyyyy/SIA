...
// Only fetch reservations where status is Pending
$stmt = $pdo->prepare("SELECT * FROM reservations WHERE status = 'Pending' ORDER BY created_at DESC");
$stmt->execute();
        ...
        <div class="table-container">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="responsive-hide">Message</th>
                            <th>Status</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="responsive-hide"><?= $row['message'] ?></td>
                            <td><span class="badge"><?= $row['status'] ?></span></td>
                            <td class="actions">
                                <!-- Approve Button -->
                                <form action="table_availability.php" method="get">
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p style="font-weight: 500;">No pending reservations at this time.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
